...
public class PanneauGestion extends JPanel {
	...
	private PanneauCentral panDessin;
	...
	public void resetPopulation() {
		...
		popVilles = new PopulationVilles(config.getNbVilles(),
	 ...
	 * utiliser affineTransform mais ça ne me tentait pas de l'expliquer pour le
	 * gain
