...
public class PanneauCentral extends JPanel {
	 ...
	 * @param tailleDessin
	 */
	public PanneauCentral(PopulationVilles popVilles,
	 ...
	 */
	private void initComposants(Dimension tailleCentre) {
		...
		config.setMaxX(tailleCentre.width);
		config.setMaxY(tailleCentre.height);

		UtilitaireSwing.setDimension(this, tailleCentre);
	...
	public void dessinerLiens(Graphics2D g2) {
		...
		/*
		 * Stratégie : On parcourt tous les liens et on fait dessiner les villes et le
		 * lien
	...
	private void dessinerUneVille(Ville v, Graphics2D g2, int taille) {
		...
		/*
		 * Stratégie : La taille des villes à l'écran est calculée selon le nombre de
		 * villes
